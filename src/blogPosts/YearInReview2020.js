            ...
            <article className="text-justify">
                ...
                <Carousel>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">My parents and I celebrating me getting a real job</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                ...
                <Carousel>
                    ...
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/vermont-2.JPG" alt="Group photo by the lake" />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/vermont-4.JPG" alt="Group picture" />
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">We went swimming in a waterfall!</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/vermont-5.JPG" alt="Dinner photo" />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">Mom, grandpa, and me</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/vermont-7.jpg" alt="Group photo" />
                        <Carousel.Caption>
                ...
                <div className="text-center">
                    <figure className="figure">
                        <img className="img-fluid" src="/blogAssets/img/2020/outdoor-nursing-graduation.JPG" alt="Nuring school graduation" />
                ...
                <Carousel>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/cincy-nursing-exam-1.JPG" alt="A house picture" />
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">Grandma's family home in Cincinatti</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/cincy-nursing-exam-2.JPG" alt="A house picture" />
                        <Carousel.Caption>
                ...
                <Carousel>
                    ...
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/woodlawn-bob-dinner-3.JPG" alt="Group photo inside" />
                        <Carousel.Caption>
                ...
                <Carousel>
                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">Me and Hudson</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                ...
                <Carousel>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/visiting-denver-1.JPG" alt="Longboarding" />
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">Long boarding around Denver</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/visiting-denver-2.JPG" alt="Group photo" />
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">A mirror selfie</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/visiting-denver-3.JPG" alt="Group photo" />
                        <Carousel.Caption>
                ...
                <Carousel>
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/tom-1.jpg" alt="Family photo" />
                        <Carousel.Caption>
                    ...
                    <Carousel.Item>
                        ...
                        <Carousel.Caption>
                            <p className="d-inline-flex px-2 mb-4 bg-dark rounded">Tom the wrestling coach and Anna</p>
                        </Carousel.Caption>
                    </Carousel.Item>
                    <Carousel.Item>
                ...
                <Carousel>
                    ...
                    <Carousel.Item>
                        <img className="d-block w-100" src="/blogAssets/img/2020/bob-family-history-6.JPG" alt="Yearbook photo" />
                        <Carousel.Caption>
